													...
													*/
													...
													var results="("+dan+$(dataFonts[2]).text()+dan+dou+nums+dou+dan+$(dataFonts[5]).text()+dan+dou+dan+$(dataFonts[4]).text()+dan+dou+dan+times+dan+dou+dan+ctf+dan+dou+nowgrate+dou+dan+$(dataFonts[1]).text()+dan+dou+dan+sure+dan+dou+dan+sure+dan+dou+dan+username+dan+dou+nowsumfen+"),";
													// alert(results);
													...
													*/
													...
													var rowId=$(ob).parent().parent().attr('id');//所在行的id
														// alert(rowId);
													var rowId=rowId.toString();
													var doms="font[name='"+rowId+"f']";
													// alert(doms);
													var dataFont=$(doms);//取到所有name=rowid的数组
													// var test1=$("font[name='55f']");
												// alert($(test1[1]).text());
