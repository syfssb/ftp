...
<div class="container_12 div_abs">
    ...
    <div class="clearfix">&nbsp;
    <form action="/Home/Grate/index"  method="get" class="form-horizontal">
...
　　　　
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">   
        <tbody><tr class="even">        
            ...
            <th width="33%" scope="col">机构名称</th>
            <th width="33%" scope="col">兑换率</th>
            <th width="33%" scope="col">操作</th>           
        </tr>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>   
           
            <td scope="col"><?php echo ($vo["inst_name"]); ?></td>
            <td scope="col"><?php echo ($vo["gift_grate"]); ?></td>
            <td scope="col"> 
            <a href="/Home/Grate/modiview/id/<?php echo ($vo["inst_no"]); ?>/grate/<?php echo ($vo["gift_grate"]); ?>/name/<?php echo ($vo["inst_name"]); ?>">修改</a>
			</td>              
