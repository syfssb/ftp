...
<div id="header" class="png_bg">
    ...
    <ul>
	<li><a href="" >会员兑换信息</a></li>
	<li><a href="" >会员信息更改日志</a></li>
	<li><a href="/Home/Grocery/index">礼品库存信息</a></li>
	<li><a href="" >礼品库存出入日志</a></li>
	<li><a href="" >兑换比率信息</a></li>
	<li><a href="" >兑换比率更换日志</a></li>
	<?php if(($instlv) == "1"): ?><li><a href="" >业务类别信息</a></li><?php endif; ?>
...
<div id="admin_wrapper">
            ...
            <form action="/Home/Main/index" id="loginform" method="post">
                ...
                <p>
                    <input name="btnLogin" type="submit" class="submit" id="btnLogin" value="登录" />
