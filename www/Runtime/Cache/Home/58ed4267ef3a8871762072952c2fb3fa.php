...
<!-- 客户信息查询=====孙云峰 -->
    ...
    <div class="clearfix">&nbsp;
    <form action="/Home/GroceryLog/buyCheck"  method="get" class="form-horizontal">
...
　　　	　　
		...
		　<label>礼品属性:</label><input  type="text" class="text" name="bgiftlog_type"  />
		<label>礼品条形码:</label><input type="text" class="text" name="bgiftlog_code"  />	<br/><br/>
			<label>管理员:</label><input type="text" class="text" name="bgiftlog_username"  />	
        ...
        <tbody><tr class="even">        
            ...
            <th width="10%" scope="col">管理员</th>
			 <th width="10%" scope="col">属性</th>
			  <th width="10%" scope="col">进价(元/件)</th>
			   <th width="10%" scope="col">采购数量</th>
    ...
    <?php if(is_array($logList)): $i = 0; $__LIST__ = $logList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>   
            ...
            <td scope="col"><?php echo ($vo["bgiftlog_code"]); ?></td>
            <td scope="col"><?php echo ($vo["bgiftlog_username"]); ?></td>
            <td scope="col"><?php echo ($vo["bgiftlog_type"]); ?></td>
            <td scope="col"><?php echo ($vo["bgiftlog_price"]); ?></td>
            <td scope="col"><?php echo ($vo["bgiftlog_num"]); ?></td>
            <td scope="col"><?php echo ($vo["bgiftlog_time"]); ?></td>
