...
<div class="container_12 div_abs">
    ...
    <form action="/Home/Ex/index"  method="post" class="form-horizontal" name="queryFen">
...
<label>可用积分:</label><font color="red" style="font-size: 25px" ><strong id="avfen"><?php echo ($vrplist["fen"]); ?></strong></font>  
             　　　　　<a href="/Home/Ex/duiShow/ctf/<?php echo ($vrplist["0"]["vrp_ctf"]); ?>/fen/<?php echo ($vrplist["fen"]); ?>/name/<?php echo ($vrplist["0"]["vrp_name"]); ?> "  id="showL"> 前往兑换</a> 
