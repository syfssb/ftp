...
<!-- 客户信息查询=====孙云峰 -->
    ...
    <div class="clearfix">&nbsp;
    <form action="/Home/GroceryLog/faCheck"  method="post" class="form-horizontal">
...
　　　	　　
		...
		　<label>礼品属性:</label><input  type="text" class="text" name="exgiftlog_type"  />
		<label>礼品条形码:</label><input type="text" class="text" name="exgiftlog_code"  />	<br/><br/>
		<label>管理员:</label><input type="text" class="text" name="exgiftlog_username"  />	
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">   
        <tbody><tr class="even">        
			...
			<th width="10%" scope="col">属性</th>
			 ...
			 <th width="10%" scope="col">接收方机构号</th>
			 <th width="10%" scope="col">管理员</th>
			   <th width="10%" scope="col">分发数量</th>
    ...
    <?php if(is_array($logList)): $i = 0; $__LIST__ = $logList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>   
            ...
            <td scope="col"><?php echo ($vo["exgiftlog_code"]); ?></td>
			<td scope="col"><?php echo ($vo["exgiftlog_type"]); ?></td>
            <td scope="col"><?php echo ($vo["exgiftlog_source"]); ?></td>
			<td scope="col"><?php echo ($vo["exgiftlog_rvinst"]); ?></td>
			<td scope="col"><?php echo ($vo["exgiftlog_username"]); ?></td>
            <td scope="col"><?php echo ($vo["exgiftlog_num"]); ?></td>
            <td scope="col"><?php echo ($vo["exgiftlog_time"]); ?></td>
