...
<!-- 客户信息查询=====张冬冬-->
    <h2>用户信息查询</h2>              
    <div class="clearfix">&nbsp;
    <form action="/Home/User/index"  method="post" class="form-horizontal">
		...
		<!--<label>机构号:</label><input  type="text" class="text" name="user_inst"  />&nbsp;-->
		<label>用户姓名:</label><input type="text" class="text" name="username"  />
     ...
     　　
		<input type="submit"  class="" value="查 询" /> 　　 　　
		<a href="/Home/User/userAdd">添加用户</a>
		<!--<input type='' name='cao' value='<?php echo ($cao); ?>'/>-->
		</form>
	</div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">   
        <tbody><tr class="even">        
            ...
            <th width="25%" scope="col">机构号</th>
            <th width="30%" scope="col">用户姓名</th>
        ...
        <?php if(is_array($userlist)): $i = 0; $__LIST__ = $userlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>   
            ...
            <td scope="col"><?php echo ($vo["user_inst"]); ?></td>          
            <td scope="col"><?php echo ($vo["user_name"]); ?></td>
            <td scope="col"><a href="/Home/User/userModify?userid=<?php echo ($vo["user_id"]); ?>">修改</a> <a name="del" href="/Home/User/user_del?userid=<?php echo ($vo["user_id"]); ?>">删除</a></td>                  
        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
    </tbody></table> 
           <div class="pagelist"><?php echo ($page); ?></div>
           <div class="clearfix">&nbsp;</div>
<script type="text/javascript" src="/Public/Home/only.inst.js"></script>
<script src="/Public/Home/js/User/index.js"></script>
