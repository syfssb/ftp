...
<div class="container_12 div_abs">
 <h2>兑换率更改日志查询</h2>     
    ...
    <div class="clearfix">&nbsp;
    <form action="/Home/GrateLog/index"  method="get" class="form-horizontal">
...
　　　	　　
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">   
        <tbody><tr class="even">        
            <th width="20%" scope="col">机构名称</th>
			 <th width="40%" scope="col">管理员</th>
			   <th width="10%" scope="col">原兑换比率</th>
               <th width="10%" scope="col">现兑换比率</th> 
            <th width="20%" scope="col">录入时间</th>           
        </tr>
    <?php if(is_array($List)): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>   
            <td scope="col"><?php echo ($vo["inst_name"]); ?></td>
            <td scope="col"><?php echo ($vo["grates_log_username"]); ?></td>
            <td scope="col"><?php echo ($vo["grates_log_past"]); ?></td>
			<td scope="col"><?php echo ($vo["grates_log_now"]); ?></td>
            <td scope="col"><?php echo ($vo["grates_log_time"]); ?></td>
